...
def _build_judge_engine_kwargs(cfg: "RunConfig") -> dict[str, object]:
    judge_kwargs = dict(cfg.model.engine_kwargs)
    judge_kwargs.update(cfg.judge.engine_kwargs)
    return judge_kwargs
...
def main(cfg: "RunConfig"):
    ...
    judge_chat_model = make_model(
        ...
        chat_template=cfg.model.chat_template,
        **_build_judge_engine_kwargs(cfg),
    )
